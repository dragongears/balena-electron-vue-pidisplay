...
(function () {
  ...
  var caf = global.cancelAnimationFrame || global.webkitCancelAnimationFrame || global.mozCancelAnimationFrame || global.oCancelAnimationFrame || global.msCancelAnimationFrame
...
var WIND_OFFSETS = [{ start: 0.36, end: 0.11 }, { start: 0.56, end: 0.16 }]
  ...
  set: function (el, draw) {
    ...
    for (i = this.list.length; i--;) {
      if (this.list[i].element === el) {
        this.list[i].drawing = this.ddf(draw)
